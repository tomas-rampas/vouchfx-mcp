...
- **Read-only**: the server never writes, modifies, or deletes a suite file. It never hosts a model — free-text intent is host-LLM territory; `scaffold_suite` takes structured input only.
