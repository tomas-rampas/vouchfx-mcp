...
DOCS: list[tuple[str, ...]] = [
    ...
    (
        ...
        "What it wraps and what it doesn't, the sixteen tools and two documentation resources plus "
    ...
    (
        ...
        "Overview, engine pin, secret hygiene, and how the sixteen tools fit together.",
    ),
    (
...
<div class="container portal">
  ...
  <section class="portal__group">
    ...
    <div class="doc-cards">
      <a class="doc-card" href="docs/overview.html">
        ...
        <p>What it wraps and what it doesn't, the sixteen tools and two documentation resources plus the error-catalogue resource family at a glance, honest prerelease status, secret hygiene, and the engine pin.</p>
      </a>
  ...
  <section class="portal__group">
    ...
    <div class="doc-cards">
      <a class="doc-card" href="README.html"><span class="doc-card__k">README</span><h3>Repository README</h3><p>Overview, engine pin, secret hygiene, and how the sixteen tools fit together.</p></a>
...
<footer class="footer">
  <div class="container footer__inner">
    <div class="footer__brand">
      <span class="brand__mark" aria-hidden="true"></span>
      <div><strong>vouchfx-mcp</strong><p>A local stdio MCP server wrapping the packaged vouchfx CLI — sixteen tools, two vendored documentation resources, and an error-catalogue resource family for AI coding agents.</p></div>
    </div>
...
CONFIG = SiteConfig(
    ...
    # written marketing.
    llms_summary=(
        "A local stdio MCP server wrapping the packaged vouchfx CLI: sixteen tools, two "
