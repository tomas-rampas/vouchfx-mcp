  ...
  <section class="portal__group">
    ...
    <div class="doc-cards">
      <a class="doc-card" href="docs/overview.html">
        ...
        <p>What it wraps and what it doesn't, the six tools and two resources at a glance, honest prerelease status, secret hygiene, and the engine pin.</p>
      </a>
...
<footer class="footer">
  <div class="container footer__inner">
    <div class="footer__brand">
      <span class="brand__mark" aria-hidden="true"></span>
      <div><strong>vouchfx-mcp</strong><p>A local stdio MCP server wrapping the packaged vouchfx CLI — six tools and two vendored documentation resources for AI coding agents.</p></div>
    </div>
