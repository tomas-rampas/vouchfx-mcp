...
DOCS: list[tuple[str, ...]] = [
    ...
    (
        ...
        "Overview, engine pin, secret hygiene, and how the eighteen tools fit together.",
    ),
    (
...
<div class="container portal">
  ...
  <section class="portal__group">
    ...
    <div class="doc-cards">
      <a class="doc-card" href="README.html"><span class="doc-card__k">README</span><h3>Repository README</h3><p>Overview, engine pin, secret hygiene, and how the eighteen tools fit together.</p></a>
...
<footer class="footer">
  <div class="container footer__inner">
    <div class="footer__brand">
      <span class="brand__mark" aria-hidden="true"></span>
      <div><strong>vouchfx-mcp</strong><p>A local stdio MCP server wrapping the packaged vouchfx CLI — eighteen tools, two vendored documentation resources, and an error-catalogue resource family for AI coding agents.</p></div>
    </div>
...
CONFIG = SiteConfig(
    ...
    # written marketing.
    llms_summary=(
        "A local stdio MCP server wrapping the packaged vouchfx CLI: eighteen tools, two "
