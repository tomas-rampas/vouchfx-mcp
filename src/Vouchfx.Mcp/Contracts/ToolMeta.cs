...
// attached at exactly one place — Tools/StructuredToolResult.Success, the single pathway all ten
// tools use to reach the wire — rather than being a field on each of the ten payload records; see
