...
// attached at exactly one place — Tools/StructuredToolResult.Success, the single pathway all nine
// tools use to reach the wire — rather than being a field on each of the nine payload records; see
