...
// attached at exactly one place — Tools/StructuredToolResult.Success, the single pathway all twelve
// tools use to reach the wire — rather than being a field on each of the twelve payload records; see
