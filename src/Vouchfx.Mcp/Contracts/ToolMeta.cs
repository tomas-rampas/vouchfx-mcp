...
// attached at exactly one place — Tools/StructuredToolResult.Success, the single pathway all seventeen
// tools use to reach the wire — rather than being a field on each of the seventeen payload records; see
