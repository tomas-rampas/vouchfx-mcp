...
internal static class VfxCodeCatalogue
{
    ...
    [
        ...
        new(RunOptionUnavailable, "RunOptionUnavailable", VfxCodeKind.Error, Retryable: false, LegacyKind: null,
            ...
            //      the pinned engine (`vouchfx run --help`, v1.0.0-rc.5, and again at v1.0.0-rc.6):
            //      there is no such flag on the CLI at all, so there is nothing to pass through. This server will not
