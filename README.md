...
the packaged [`vouchfx`](https://github.com/tomas-rampas/vouchfx) CLI. It advertises eleven tools to validate
...
> spec → build → review loop, one requirement at a time. All eleven tools, both vendored-document MCP resources,
